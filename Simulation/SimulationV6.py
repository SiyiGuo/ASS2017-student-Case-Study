...
def candidate_list():
	...
	return agriculture, fishing, private_housing, conservation, recreation, \
...
def calculate_score(current_plan):
	...
	for function in current_plan:
		#function1= conservation, function=2 recreation, function=3 fishing
		#function4=agriculture, function = 5 private housing 
...
def simulation(agriculture, fishing, private_housing, conservation, 
						recreation, electricity, harbour, block_var_score):
...
global score_table
score_table = read_excel("island_scoreV2.xlsm")


agriculture, fishing, private_housing, conservation, recreation, electricity, \
harbour, block_var_score= candidate_list()
